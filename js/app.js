...
function updateStorage()
{
 ...
 //  console.log('befor:',Product.arrproduct);
   let stringArr=JSON.stringify(Product.arrproduct);
...
function SaveProduct()
{
  ...
  let strarr=JSON.parse(data);
 // console.log('new',strarr);

  if(strarr!==null)

  {  Product.arrproduct=strarr;
